...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 66; // addresses start with "2"
...
const uint64_t MONEY_SUPPLY                                  = 8265395001600000000;
...
const uint64_t COIN                                          = UINT64_C( 1000000000000);  // pow(10, 8)
const uint64_t MINIMUM_FEE                                   = UINT64_C( 5000000000);    // pow(10, 6)
...
const size_t   MAX_BLOCK_SIZE_INITIAL                        = 55 * 1024;
...
const uint64_t UPGRADE_HEIGHT                                = 445900;
...
const char     CRYPTONOTE_NAME[]                             = "OneEvilCoin";
